...
import com.sunrise.cinema.Adapter.PageTransformer;
import com.sunrise.cinema.Adapter.PagerViewAdapter;
import com.sunrise.cinema.DB.DbHelper;
import com.sunrise.cinema.DB.Manager;
import com.sunrise.cinema.DB.Movie;
import com.sunrise.cinema.activities.CinemaActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.toolbarText)).setText(getString(R.string.app_name));
...
//        getSupportActionBar().setDisplayUseLogoEnabled(true);
    ...
    private boolean TimeMIls() {
        ...
        if (currentTime - previousTime > TimeUnit.HOURS.toMillis(2)) {
    ...
    public void setDisplay() {
        ...
        up_line.setLayoutParams(new LinearLayout.LayoutParams(width, height));
    }
                    ...
                    try {
                        ...
                        if (result2 != null) {
                            ...
                            for (int i = 0; i < jsonArray2.length(); i++) {
                                ...
                                com.sunrise.cinema.dbt.Manager.save(db2, new TimeTable(hall_title, movie_title, theatre_title, date, price, codeid));
                            }
                        }
